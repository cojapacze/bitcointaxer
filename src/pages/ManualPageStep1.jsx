  ...
  <div>
    <div className="steps-content">
      ...
      <div className="manual-exchanges">
        <Card className="manual-exchange-card" title="pro.coinbase.com">
          <p>
            <FormattedMessage
        ...
        <Card className="manual-exchange-card" title="coinbase.com">
          <p>
            <FormattedMessage
              id="ManualPageStep1.coinbaseExport"
              defaultMessage="Set correct <a>https://www.coinbase.com/settings/preferences local currency</a> and download the file into a common <b>catalog</b>:"
              values={globalMessageValues}
            />
          </p>
          <ul>
            <li>
              Coinbase-TaxTransactionsReport.csv{' '}
              <a
                rel="noopener noreferrer"
                target="_blank"
        ...
        <Card className="manual-exchange-card" title="binance.com">
          <p>
            <FormattedMessage
        ...
        >
          <p>
            <FormattedMessage
              ...
              defaultMessage="Download the file <filename>{filename}</filename> and save in the designated <strong>catalog</strong>."
              values={{
                ...globalMessageValues,
                filename: function Filename() {
                  return <strong>ledgers.zip</strong>;
                },
              }}
            />
          </p>
        ...
        >
          <p>
            <FormattedMessage
              ...
              defaultMessage="Save remaining files into the same, designated <strong>catalog</strong>:"
              values={globalMessageValues}
            />
          </p>
          <ul>
        ...
        <Card className="manual-exchange-card" title="bitmarket.pl">
          <FormattedMessage
            id="ManualPageStep1.save"
            defaultMessage="Save remaining files into the same, designated <b>catalog</b>:"
            values={globalMessageValues}
        ...
        <Card className="manual-exchange-card" title="wavesplatform.com">
          <FormattedMessage
            id="ManualPageStep1.export"
            defaultMessage="Export the files into a common <b>catalog</b>:"
            values={globalMessageValues}
        ...
        >
          ...
          <code
            ...
            className="raw code csv"
          >{`#custom,my custom operations 1
