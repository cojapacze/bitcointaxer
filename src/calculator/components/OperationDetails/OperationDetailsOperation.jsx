...
import {TableCostBasis} from '../Tables';
...
class OperationDetailsOperation extends React.Component {
  ...
  componentWillUnmount() {
    this.operationQueue.removeListener(
      'change-currentOperation',
      this.recordChanged,
    );
  }
    ...
    return (
      <Form>
        <div style={{marginTop: '32px'}}>
          ...
          {operation.taxable ? (
            <div>
              ...
              <Form.Item
                ...
                label={
                  <PrintGainLossLabel
                    gainLoss={calculatorStep.operationGainLoss}
                  />
                }
              >
                <PrintAsset
          ...
          <div key={'used-assets'} style={{marginTop: '56px'}}>
            <TableCostBasis
              key={'o-used-costs'}
              title={
                <span>
              ...
              expenseList={
                (calculatorStep.operationCostsTaken &&
                  calculatorStep.operationCostsTaken.usedCosts) ||
                []
              }
