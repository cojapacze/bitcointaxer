...
class EditSetupCalculator extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Form className={'compact-form'} onSubmit={this.handleSubmit}>
          <Form.Item
            {...formItemLayout}
            ...
            style={{display: 'none'}}
          >
            {getFieldDecorator('valuationPriceServer', {
              initialValue: valuationSetup.valuationPriceServer,
              rules: [
                {required: true, message: 'Choose which price server use for valuation'}
              ]
            })(
              <Select
                onChange={e => this.setSetting('valuationPriceServer', e)}
              >
                <Select.Option value="https://priceserver.bitcointaxer.org:8088">https://priceserver.bitcointaxer.org:8088</Select.Option>
                <Select.Option value="https://priceserver.bitcointaxer.com:8081">https://priceserver.bitcointaxer.com:8081</Select.Option>
                <Select.Option value="http://localhost:8081">http://localhost:8081</Select.Option>
              </Select>
            )}
          </Form.Item>
          ...
          <Form.Item
            ...
            />}
          >
            {getFieldDecorator('valuationSide', {
              initialValue: valuationSetup.valuationSide,
              rules: [
          ...
          <Form.Item
            ...
            />}
          >
            {getFieldDecorator('valuationStrategy', {
              initialValue: valuationSetup.valuationStrategy,
              rules: [
                {required: true, message: <FormattedMessage
          ...
          <Form.Item
            ...
            />}
          >
            {getFieldDecorator('valuationPrice', {
              initialValue: valuationSetup.valuationPrice,
              rules: [
                {required: true, message: <FormattedMessage
          ...
          <Form.Item
            ...
            />}
          >
            {getFieldDecorator('valuationCTCDiscount', {
              initialValue: valuationSetup.valuationCTCDiscount,
              rules: [
                {required: true, message: <FormattedMessage
